...
export const DecibelMeter: React.FC = () => {
  ...
  const startListening = async () => {
    try {
      ...
      alert(
        "Microphone access denied. Please allow it to use the decibel meter.",
      );
    }
  };
  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-3 py-1.5 rounded-full border transition-all text-sm font-bold shadow-md focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-bg-deep",
          isListening
            ? isDanger
      ...
      >
        <Volume2
          size={14}
          className={cn(isListening && isDanger && "animate-bounce")}
        />
        {isListening ? (
        ...
        <div className="absolute top-full right-0 mt-3 w-72 bg-bg-card border border-border-main rounded-xl shadow-2xl z-[100] animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
          <div className="p-4 border-b border-border-main bg-black/40 flex justify-between items-center">
            ...
            <button
              ...
              className={cn(
                "p-1.5 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-bg-deep",
                isListening
          ...
          <div className="p-4 space-y-4">
            <div className="relative h-4 bg-black rounded-full overflow-hidden border border-white/10">
              <div
                ...
                style={{
                  width: `${Math.min(100, Math.max(0, (db / 120) * 100))}%`,
                }}
              />
              <div
                className="absolute inset-y-0 w-0.5 bg-white/50 transition-all duration-300"
                style={{
                  left: `${Math.min(100, Math.max(0, (maxDb / 120) * 100))}%`,
                }}
              />
            </div>
            ...
            <div className="flex justify-between items-end">
              ...
              <div className="text-right">
                ...
                <div className="text-xl font-bold font-mono text-text-bright tracking-tighter">
                  {Math.round(maxDb)}{" "}
                  <span className="text-xs text-text-dim">dB</span>
                </div>
              </div>
            </div>

            <div className="pt-4 border-t border-white/5 space-y-2">
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-text-dim mb-3">
                Health Standards
              </h4>
              ...
              <div className="flex items-start gap-2 text-[10px]">
                ...
                <div>
                  ...
                  <p className="text-text-dim mt-0.5">
                    Normal conversation. Safe for any duration.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 text-[10px]">
                ...
                <div>
                  ...
                  <p className="text-text-dim mt-0.5">
                    Heavy traffic. Limit long term exposure.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 text-[10px]">
                ...
                <div>
                  ...
                  <p className="text-text-dim mt-0.5">
                    Concerts/Clubs. Can cause permanent damage without earplugs.
                  </p>
                </div>
              </div>
            </div>
            ...
            {isDanger && (
              <div className="mt-2 p-2 bg-red-500/10 border border-red-500/20 rounded flex items-start gap-2 text-red-400">
                ...
                <p className="text-[10px] leading-relaxed">
                  Levels are critically high. Ear protection is strongly
                  recommended.
                </p>
              </div>
            )}
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={() => setMaxDb(0)}
                className="text-[10px] text-text-dim hover:text-text-bright uppercase font-bold tracking-widest transition-colors focus-visible:ring-2 focus-visible:outline-none rounded px-1"
              >
                Reset Peak
              </button>
            </div>
