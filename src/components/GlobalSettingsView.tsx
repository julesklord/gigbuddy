          ...
          <div className="bg-bg-card border border-border-main rounded-xl p-4 sm:p-6 space-y-8">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full h-2 bg-text-bright/10 rounded-lg appearance-none cursor-pointer accent-brand focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none"
              />
            </div>
