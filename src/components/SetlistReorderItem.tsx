      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="opacity-100 lg:opacity-0 group-hover:opacity-100 focus-visible:opacity-100 p-2 text-red-500/70 hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-all"
            title="Delete Song"
