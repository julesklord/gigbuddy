    ...
    <PluginContainer title="Live Metronome">
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center text-xs">
          <label htmlFor="metronome-bpm-slider" className="cursor-pointer">
            Tempo: {bpm} BPM
          </label>
        ...
        <input
          ...
          className="w-full accent-brand bg-white/10 h-1 rounded-lg appearance-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-bg-deep"
        />
        <button
